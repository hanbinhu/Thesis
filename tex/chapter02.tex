...
如\parencite{Meta_CN}。
使用\verb+\parencite{key1,key2,key3...}+则可以产生水平引用的参考文献，例如。
请看下面的例子，将会穿插使用水平的和上标的参考文献：关于书的\parencite{Meta_CN,JohnD}，关于期刊的\parencite{chen2007ewi}，
会议论文\parencite{DPMG,DPMG1,DPMG2,DPMG3,DPMG4,DPMG5,DPMG6,DPMG7}，
硕士学位论文\parencite{zhubajie}，博士学位论文，电子文献，用户手册。
